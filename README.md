...
## Branch Manager Self Registration
- Login page now has Register as Branch Manager.
- Registered branch managers are inactive until Admin approval.
- Admin approves at Admin -> Approvals.
- After approval, the branch manager can login normally and link a phone using the QR flow.
